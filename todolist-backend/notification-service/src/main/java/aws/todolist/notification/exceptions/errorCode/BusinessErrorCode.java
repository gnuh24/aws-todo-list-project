package aws.todolist.notification.exceptions.errorCode;
...
public class BusinessErrorCode {
    ...
    // ==== TASKFLOW ====
    public static final String TASKFLOW_NOT_FOUND = "SYS-TAS-001"; // Không tìm thấy đối tượng
    public static final String TASKFLOW_ACCESS_DENIED = "SYS-TAS-002"; // Không có quyền truy cập vào dự án hoặc không có quyền thực hiện
}
