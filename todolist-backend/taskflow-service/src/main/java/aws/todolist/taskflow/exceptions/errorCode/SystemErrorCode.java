package aws.todolist.taskflow.exceptions.errorCode;
...
public final class SystemErrorCode {
    ...
    // ==== TASKFLOW ====
    public static final String SYS_OBJECT_NOT_FOUND = "SYS-TAS-001"; // Không tìm thấy đối tượng
    public static final String SYS_TASKFLOW_ACCESS_DENIED = "SYS-TAS-002"; // Không có quyền truy cập vào dự án hoặc không có quyền thực hiện
