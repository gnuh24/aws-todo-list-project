...
public class TaskController {
    ...
    public ResponseEntity<ApiResponse<List<TaskResponseDTO>>> getTaskUpComing() {
        List<TaskResponseDTO> listTask = taskService.getTaskUpComing();
    ...
    @RequireProjectRole({Role.OWNER, Role.MEMBER})
    public ResponseEntity<ApiResponse<TaskResponseDTO>> updateStatus(@PathVariable("idProject") String idProject, @PathVariable("idTask") String idTask, @RequestBody @Valid TaskUpdateStatusRequestDTO requestDTO) {

        TaskResponseDTO taskResponseDTO = taskService.updateStatus(idTask, requestDTO);
