package com.aws.todolist.exceptions;

import com.aws.todolist.aop.AppLogger;
import com.aws.todolist.exceptions.AuthException.StepUpAuthenticationException;
import com.aws.todolist.exceptions.JwtException.*;
import com.aws.todolist.exceptions.errorCode.SystemErrorCode;
import com.aws.todolist.exceptions.otpException.OtpNotFoundException;
