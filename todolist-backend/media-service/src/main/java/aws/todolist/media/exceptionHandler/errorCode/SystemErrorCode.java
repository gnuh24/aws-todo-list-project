...
public final class SystemErrorCode {
	...
	public static final String SYS_RESOURCE_NOT_FOUND 						= "SYS-SYSTEM-006";
	...
	// ==== FILE / MEDIA ====
	public static final String SYS_FILE_UNKNOWN            					= "SYS-FILE-000"; // File vượt quá dung lượng cho phép
	...
	public static final String SYS_FILE_EMPTY                     			= "SYS-FILE-005"; // File rỗng hoặc null
	public static final String SYS_FILE_NAME_INVALID              			= "SYS-FILE-006"; // Tên file không hợp lệ
	public static final String SYS_FILE_ACCESS_DENIED              			= "SYS-FILE-007"; // Không có quyền truy cập file
	public static final String SYS_FILE_STORAGE_NOT_AVAILABLE      			= "SYS-FILE-008"; // Storage lỗi / không truy cập được
