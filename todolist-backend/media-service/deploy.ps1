# ======================================================
# 🚀 AUTO DEPLOY SCRIPT: user-service (AWS ECS/Fargate)
# ======================================================
...
# ====== 2. THÔNG TIN DỊCH VỤ (USER SERVICE) ======
$SERVICE_NAME = "user-service"
$TASK_DEFINITION_NAME = "user-service-td"
$LOG_GROUP_NAME = "/ecs/user-service-td"

# ====== 3. CẤU HÌNH ECR ======
# Lưu ý: Đảm bảo bạn đã tạo Repository tên 'user-service' trên ECR
